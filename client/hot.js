...
function check(options, onCheckStarted, onCheckDone) {
  module.hot.check().then(function (modules) {
    ...
    return module.hot.apply(hotOpts).then(function (appliedModules) {
      if (!upToDate()) {
        check(options, onCheckStarted, onCheckDone);
      }
...
module.exports = function update(currentHash, options, onCheckStarted, onCheckDone) {
